...
only listen to minute number of episodes.
...
Secondly, there’s a goal of full, comprehensive, longitudinal
downloading and archiving of podcast episodes. Then the application of
transcription software for text conversion. Next full text and vector
search indexing. 
...
- "where else in my space ofepisodes did this concept appear?", 
